        ...
        data.main_tracks.forEach(track => {
          ...
          list.append(`
            <div class="flex items-center p-6 bg-white rounded-xl shadow hover:shadow-md transition"
              ...
              <img src="${track.album_cover}" alt="Album cover" class="w-28 h-28 object-cover rounded-lg flex-shrink-0">
              ...
              <div class="flex-1 flex flex-col ml-4">
                ...
                <div class="mt-3 flex items-center gap-3">
                  ...
                  <button class="share-btn text-gray-500 w-10 h-10 flex items-center justify-center rounded-full hover:bg-gray-200" title="공유">
      ...
      if (data.surprise_track) {
        ...
        $("#surprise-container").html(`
          ...
          <div class="flex items-center p-6 bg-white rounded-xl shadow"
            ...
            <img src="${st.album_cover}" alt="Album cover" class="w-28 h-28 object-cover rounded-lg flex-shrink-0">
            ...
            <div class="flex-1 flex flex-col ml-4">
              ...
              <div class="mt-3 flex items-center gap-3">
                  ...
                  <button class="share-btn text-gray-500 w-10 h-10 flex items-center justify-center rounded-full hover:bg-gray-200" title="공유">
                      <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l-4.5 4.5a4.5 4.5 0 001.242 7.244" /></svg>
                  </button>
              </div>
            </div>
            ${audioControlHTML}
...
$(document).on("click", ".share-btn", function () {
  ...
  const trackId = trackDiv.data("track-id"); 
